...
export type VModalSize = 'none' | 'small' | 'medium' | 'large' | 'big'
...
const cancelLabel = computed(() => props.cancelLabel || t('action.cancel'))
    ...
    <FocusTrap :initial-focus="() => ($refs.closeButton as any)?.el">
      ...
      >
        ...
        <div class="modal-content">
          ...
          <header v-if="!noheader" class="modal-card-head">
            <h3>{{ title }}</h3>
            <button
              ref="closeButton"
