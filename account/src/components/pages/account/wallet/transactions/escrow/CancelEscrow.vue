...
import { txTokenCancelEscrow } from "/@src/utils/wallet/transaction";
...
const handleTx = async () => {
  const transactionInstance = await txTokenCancelEscrow(
...
<template>
  <h3 class="dark-inverted">Cancel transaction</h3>
  <MethodTransfer
    v-if="!method"
    :methods="methods"
